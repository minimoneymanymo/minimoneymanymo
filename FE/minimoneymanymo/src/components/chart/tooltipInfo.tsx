export const tooltipInfo: { [key: string]: React.ReactNode } = {
  ...
  PER: (
    <>
      ...
      <br />
      <b>이 숫자는 주식이 얼마나 비싼지를 판단하는 데 도움을 줘요.</b>
      <br />
  ...
  EPS: (
    <>
      ...
      나눈 값이에요.
      <br />
      <b>이 숫자는 주식 한 주당 얼마나 이익을 내고 있는지를 보여줘요.</b>
      <br />
  ...
  BPS: (
    <>
      ...
      주식 수로 나눈 값이에요.
      <br />
      <b>이 수치는 주식 한 주당 기업이 실제로 가진 자산의 가치를 나타내요.</b>
      <br />
  ...
  KOSPI200: (
    <>
      ...
      OSPI200의 숫자가 상승하면, 일반적으로 많은 기업이 잘 운영되고 있다는
      의미입니다. 이는 한국 경제가 좋은 방향으로 가고 있다는 신호일 수 있습니다.
      <br />
      반대로 KOSPI200의 숫자가 하락하면, 많은 기업이 어려움을 겪고 있다는 의미로
      해석될 수 있습니다. 이는 경제가 힘든 상황에 처해 있다는 신호일 수
      있습니다.
    </>
  ),
  KOSDAQ: (
