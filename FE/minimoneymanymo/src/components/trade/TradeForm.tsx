      ...
      {!accessToken ? ( // accessToken이 없을 때
        ...
        <>
          <div className="relative flex h-full w-[340px] flex-col p-2">
            ...
            <div className="absolute mt-14 flex h-[80px] w-[310px] justify-end space-x-4">
              <Button
                className={`z-10 h-16 bg-buy pb-6 text-white transition-transform duration-300 ${
                  isBuyMode ? "scale-110" : "scale-90"
                }`}
                onClick={() => setIsBuyMode(true)}
                style={{ paddingTop: "0.1px" }}
              >
              ...
              <Button
                className={`z-10 h-16 bg-sell pb-6 text-white transition-transform duration-300 ${
                  !isBuyMode ? "scale-110" : "scale-90"
                }`}
                style={{ paddingTop: "0.1px" }}
                onClick={() => {
