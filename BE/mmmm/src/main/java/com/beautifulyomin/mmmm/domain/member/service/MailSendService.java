...
public class MailSendService {
    ...
    public boolean checkAuthNum(String email, String authNum) {
        String storedEmail = redisUtil.getData(RedisKey.EMAIL_AUTHENTICATION.format(authNum));
    ...
    public void mailSend(String setFrom, String toMail, String title, String content, int code) {
        ...
        //redis에 저장
        redisUtil.setDataExpire(RedisKey.EMAIL_AUTHENTICATION.format(code), toMail, RedisExpireTime.EMAIL_CACHE_SEC.getExpireTime());
